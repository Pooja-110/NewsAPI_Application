...
public class TechnologyFragment extends Fragment {
    ...
    Adapter adapter;
    String Country="in";
    private RecyclerView recyclerViewftechnology;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewftechnology=v.findViewById(R.id.tech_fragment);
        arrayList=new ArrayList<>();
        recyclerViewftechnology.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getContext(),arrayList);
        recyclerViewftechnology.setAdapter(adapter);
